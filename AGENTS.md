...
- Consolidated repair and producer automation require the operation-selected recovery registry for every supported mutation domain. Artifact proof alone does not authorize producer automation, and a PostTransaction backup cannot represent a package artifact's pre-transaction state.
